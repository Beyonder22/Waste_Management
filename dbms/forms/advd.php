...
<div class="wrapper">
      ...
      <div class="content">
         <div class="header">
            <a href="all_driverdet.php"  class="btn">All Driver Details</a>
            <a href="add_driverdet.php"  class="btn">Add Driver Details</a>
            <a href="update_driverdet.php"  class="btn">Update Driver Details</a>
         </div>
      </div>
</div>
</body>
