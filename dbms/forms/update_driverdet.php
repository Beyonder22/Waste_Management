...
if(isset ($_POST['submit'])){
    ...
    $sql = "UPDATE vehicle set driver_name='$driver_name ',driver_contact='$driver_contact',helper_name='$helper_name',area_id='$area_id' where vehicle_id='$vehicle_id'";
...
<div class="wrapper">
      ...
      <form action="" method="POST">
            ...
            <h1>Update Driver Details</h1>
                    ...
                    <button name="submit" class="btn">Update Driver</button>
            </div>
        </form>
</div>
</body>
